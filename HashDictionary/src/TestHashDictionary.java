...
public class TestHashDictionary {
	...
	// Test 5: try to insert a duplicate entry.
	// Should throw an exception.
	try {
	    h.insert("R3C1");
	...
	// Test 6: delete an existing entry.
	...
	// Test 7: insert 200 different values into the Dictionary
	...
	else System.out.println("   Test 7 succeeded");
	...
	// Test 9: Get iterator over all keys
	fail = false;
